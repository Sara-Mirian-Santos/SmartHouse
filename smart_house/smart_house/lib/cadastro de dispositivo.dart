...
class cadastro_dispositivo extends StatefulWidget {
  const cadastro_dispositivo({super.key});

  @override
  State<cadastro_dispositivo> createState() => _cadastro_dispositivoState();
}

class _cadastro_dispositivoState extends State<cadastro_dispositivo> {
                      ...
                      Container(padding: const EdgeInsets.all(25),
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                child: Image(
                                  image: AssetImage("image/Frame 1.png"),
                                  height: 150,
                                  width: 150,
                                  fit: BoxFit.fill,
                                ),
