...
class quarto extends StatefulWidget {
  ...
  @override
  State<quarto> createState() => _quartoState();
}

class _quartoState extends State<quarto> {
  bool _bt_lampada_quarto = false;
  @override
